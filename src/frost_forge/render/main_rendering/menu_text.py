...
def render_text(window, text, position, images):
    window.blit(pg.transform.scale(images["left text"], (25, 50)), (0, position * TEXT_DISTANCE))
    window.blit(MENU_FONT.render(text, False, (19, 17, 18)), (30, position * TEXT_DISTANCE))
    window.blit(
