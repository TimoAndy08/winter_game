RECIPES = {
    ...
    "mana converter": (
        (("amethyst", 2), (("quartz", 3), ("mana", 2)), 1),
        (("citrine", 2), (("amethyst", 3), ("mana", 2)), 2),
        (("mana", 2), (("white dye", 1),), 1),
    ...
    "quartz altar": (
        ...
        (("mana converter", 1), (("purple mana", 1), ("quartz", 1), ("amethyst", 1), ("citrine", 1))),
