RECIPES = {
    ...
    "citrinic bronze boiler": (
        (("steam fluid", 5), (("water fluid", 5), ("purple mana", 1), ("fuel", 32))),
    ),
    "composter": (
        (("dirt", 1), (("compost", 4),)),
    ...
    "mana converter": (
        ...
        (("amethyst boiler", 1), (("amethyst rune", 2), ("amethyst pipe 0", 5), ("citrine", 2)), 5),
        ...
        (("citrinic bronze boiler", 1), (("amethyst boiler", 1), ("copper boiler", 1), ("citrine rune"), ("bronze ingot", 4)), 7),
        (("mana", 2), (), 1),
        (("mana converter", 1), (("purple mana", 1), ("quartz", 1), ("amethyst", 1), ("citrine", 1)), 5),
        (("nigredo child", 1), (("quartz child", 1), ("coal block", 1), ("sapphire", 1)), 6),
        (("purple mana", 2), (("mana", 7), ("purple dye", 2)), 3),
        (("slime summon", 1), (("slime crystal", 3), ("life crystal", 1)), 1),
        (("steam furnace", 1), (("stone brick", 8), ("lava rune", 1), ("amethyst wrench", 1)), 6),
    ),
    "manual press": (
        (("blue dye", 1), (("bluebell", 1), ("bowl", 1))),
        (("bronze dust", 2), (("copper dust", 3), ("tin dust", 1))),
        (("copper dust", 1), (("copper ingot", 1),)),
    ...
    "packager bench": (
        ...
        (("citrine rune", 1), (("citrine", 4), ("amethyst rune", 1))),
        (("coal", 8), (("coal block", 1),)),
        (("coal block", 1), (("coal", 8),)),
        (("copper block", 1), (("copper ingot", 8),)),
        (("copper ingot", 8), (("copper block", 1),)),
        (("gift", 1), (("package", 1), ("coal", 1))),
        (("lava rune", 1), (("lava", 2), ("purple mana", 4), ("citrine rune", 1))),
        (("nigredo", 8), (("nigredo block", 1),)),
        (("nigredo block", 1), (("nigredo", 8),)),
        (("nigredo rune", 2), (("nigredo block", 1), ("lava rune", 1), ("sapphire rune", 1))),
        (("quartz block", 1), (("quartz", 8),)),
        (("quartz", 8), (("quartz block", 1),)),
        (("sapphire rune", 1), (("sapphire", 2), ("purple mana", 4), ("citrine rune", 1))),
    ),
    "player": (
        (("snowball", 4), (("snow", 1),)),
        (("stick", 4), (("wood", 2),)),
    ...
    "steam furnace": (
        ...
        (("pure crystal", 1), (("quartz", 1), ("steam fluid", 2))),
        (("slime crystal", 1), (("slime ball", 1), ("steam fluid", 2))),
        (("tin ingot", 1), (("tin dust", 1), ("steam fluid", 2))),
    ),
    "tree constructor": (
