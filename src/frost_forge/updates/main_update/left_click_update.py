...
def left_click(
    ...
    if machine_ui == "game":
        ...
        if is_floor and FLOOR_TYPE.get(current_tile["floor"]) == "door":
            ...
            chunks, health, max_health = place(inventory, inventory_number, is_not_tile, is_kind, health, max_health, grid_position, chunks)
        else:
        ...
        chunks, machine_inventory = open_storage(position, chunks, location, inventory, machine_ui)
