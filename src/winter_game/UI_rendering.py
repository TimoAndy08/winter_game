...
def render_UI(last_mined_location, camera, chunks, room_location, zoom, tile_location, UI_SCALE, SCREEN_SIZE, UI_FONT, BIG_UI_FONT, INVENTORY_SIZE, inventory_number, inventory, machine_ui, recipe_number, last_opened_location, health, max_health, machine_inventory):
