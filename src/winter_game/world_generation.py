...
def generate_chunk(chunk_x: int, chunk_y: int, chunks: dict[tuple[int, int], dict[tuple[int, int], Tile]],):
                    ...
                    if tile_position in tile:
                        if "multi" in tile[tile_position].attributes:
                            ...
                            for x in range(0, tile_size[0]):
                                if x != 0:
                                    tile[(tile_x + x, tile_y)] = Tile("left", 1, {})
                                for y in range(1, tile_size[1]):
                                    tile[(tile_x + x, tile_y + y)] = Tile("up", 1, {})