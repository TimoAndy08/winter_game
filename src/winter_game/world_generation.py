            ...
            for tile_y in range(0, 16):
                ...
                if tile_position not in tile:
                    ...
                    if moisture_value > 0 and -0.25 > elevation_value:
                        ...
                        tile[tile_position] = Tile("mushroom", {"spore": 2},)
                        ...
                        tile[tile_position] = Tile("tree", {"wood": 4, "sapling": 2},)
                    elif elevation_value > 0.25 and 0.35 > moisture_value > 0.15:
                        tile[tile_position] = Tile("treeling", {"wood": 2, "sapling": 1})
                        ...
                        tile[tile_position] = Tile("rabbit hole", {"rabbit adult": 2, "rabbit child": 2},)
